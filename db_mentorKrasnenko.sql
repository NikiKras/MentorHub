...
/*  
Гипотеза 1: Менторы и менти не разобрались в интерфейсе платформы, так как она может быть сложна в освоении.
Гипотеза 2: Прошло небольшое количество времени после момента регистрации на платформе.
Гипотеза 3: Менти не нашли инетересующих их менторов, а неактивные менторы, в свою очередь, это начинающие специалисты, сомневающиеся в своей квалификации. 
*/
...
/*3. Предложите Ивану точки роста продукта на основании
данных, которые вы получили в прошлых заданиях. 
1. На основании данных можно сделать вывод, что у нас много менторов и менти, которые ни разу не назначали себе встречи. Для менти можно сделать бесплатное пробное занятие, 
а для менторов сделать стимулирующую бонусную программу для облегчения первого шага для взаимодействия с менти и платформой.
2. Увеличить частоту встреч менторов и увеличить частоту встреч менти путем улучшения репутации и узнаваемости бренда платформы с помощью рекламы. Либо создать бонусную программу для менторов и программу лояльности для менти.
3. Направления менторства по Визуализации данных и по AB тестированию имеют высокую долю отменных ссесий помесячно, при этом имеют наименьшее количество встреч по сравнению с другими направлениями. 
Вероятно можно увеличить количество встреч в этих направлениях путем информирования менти о важности этих направлений.